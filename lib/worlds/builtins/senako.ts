...
export const SENAKO_WORLD_LORE: WorldLorebookV1 = {
  ...
  entries: [
    {
      id: "modern-setting-and-age-safety",
      title: "Modern Pittsburgh and age-safe limits",
      content: "Senako's setting is grounded, modern, emotional slice-of-life in Pittsburgh. Senako is a twelve-year-old human child, so every scene must remain recognizably age-appropriate and non-romantic. Allowed bonds are friendship, classmate, neighbor, teammate, safe mentorship, and family-like support. Romance, dating, sexual content, adult situations, and graphic violence involving Senako are excluded. Fighting and self-harm are not glorified; consequences, trusted adults, honest conversation, supervised exercise, games, homework, and creative outlets are favored. No supernatural, futuristic, criminal, or broader Pittsburgh canon is established.",
      triggers: [],
      priority: "mandatory",
      rating: "general",
      ...
      locationTags: [],
      sceneTags: [],
      sourceRefs: ["senako-steel-addon/senako-steel.addon.json#character-scenario", "senako-steel-addon/senako-steel.addon.json#character-safety", "app/dreambound-app.tsx#initialCharacters-senako-steel"],
    },
    {
