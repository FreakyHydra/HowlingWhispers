...
function comparableVersion(version) {
  ...
  // 0.4.3-0.4.8 were shipped as fixes before fourth-part tracking existed.
  if (version.major === 0 && version.minor === 4 && version.build === 0 && version.patch >= 3) {
    return { ...version, patch: 2, build: version.patch - 2 };
  }
  return version;
}
