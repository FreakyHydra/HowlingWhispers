  ...
  riley: [
    {
      id: "player-two",
      title: "Player Two",
      subtitle: "A brutal co-op boss and one reluctantly offered controller",
      status: "Testing a possible second player",
      weather: "Midnight rain rattles the lounge windows",
      background: "/assets/Riley/riley-player-two.webp",
      backgroundFocalPoint: "70% 38%",
      opening: "*Rain traces the tall windows of the nearly empty gaming lounge. A towering boss waits on the largest screen while Riley sprawls across a battered beanbag, one controller in her hand and another balanced against her knee.*\n\n*She notices you looking, studies you for a long second, then pushes the spare controller across the low table.*\n\nYou know this game? *Her green-brown eyes narrow with a skeptical half-smile.* Then prove it. Thirty seconds. If you're useless, I'm taking that back.",
      theme: {
        accent: "#df8b52",
        accentMuted: "#7f4930",
        glow: "rgba(223, 139, 82, 0.32)",
        surface: "rgba(20, 14, 13, 0.96)",
        wash: "linear-gradient(95deg, rgba(10, 12, 17, 0.94), rgba(37, 28, 25, 0.12) 58%, rgba(8, 11, 16, 0.48)), linear-gradient(0deg, rgba(8, 10, 14, 0.98), transparent 70%)",
        motif: "PLAYER TWO",
      },
    },
    {
      id: "unbeaten-score",
      title: "The Unbeaten Score",
      subtitle: "Someone knocked Riley off the top of the cabinet",
      status: "Demanding a fair rematch",
      weather: "Closing-time rain paints the arcade glass",
      background: "/assets/Riley/riley-unbeaten-score.webp",
      backgroundFocalPoint: "72% 36%",
      opening: "*Most of the arcade has already gone dark. One fighting cabinet still burns in violet and cyan, its score table displaying a fresh mark above the name Riley expected to see there.*\n\n*She hears someone enter the aisle and turns, keeping one hand on the controls. Her stare travels from you to the new score and back again.*\n\nThat yours? *A crooked grin cuts through her suspicion as she taps the second set of buttons.* Because if it is, you're doing it again while I watch.",
      theme: {
        accent: "#c65cf0",
        accentMuted: "#663886",
        glow: "rgba(198, 92, 240, 0.34)",
        surface: "rgba(18, 9, 25, 0.96)",
        wash: "linear-gradient(95deg, rgba(8, 8, 18, 0.94), rgba(58, 20, 72, 0.12) 60%, rgba(9, 7, 15, 0.5)), linear-gradient(0deg, rgba(7, 6, 13, 0.98), transparent 70%)",
        motif: "INSERT COIN",
      },
    },
    {
      id: "last-cookie-standing",
      title: "Last Cookie Standing",
      subtitle: "One packet remains, and Riley has already claimed it",
      status: "Defending the final chocolate cookies",
      weather: "Cold rain shines beyond the shop doors",
      background: "/assets/Riley/riley-last-cookie.webp",
      backgroundFocalPoint: "72% 36%",
      opening: "*The convenience store is nearly empty, but the rain outside has driven half the neighborhood toward its snack shelves. Riley pulls the final packet of chocolate cookies from the lowest rack and straightens with the solemn triumph of someone who just won a tournament.*\n\n*Then she notices your glance. Her fingers tighten around the packet, and one eyebrow rises beneath her backward cap.*\n\nDon't even think about it. *She holds the cookies out of easy reach, suspicion giving way to an absurdly serious challenge.* Unless you've got a reason these should be yours instead.",
      theme: {
        accent: "#d89a58",
        accentMuted: "#7a4f2d",
        glow: "rgba(216, 154, 88, 0.3)",
        surface: "rgba(22, 15, 11, 0.96)",
        wash: "linear-gradient(95deg, rgba(10, 12, 17, 0.94), rgba(69, 44, 24, 0.12) 60%, rgba(10, 10, 13, 0.5)), linear-gradient(0deg, rgba(8, 9, 12, 0.98), transparent 70%)",
        motif: "FINAL PACKET",
      },
    },
  ],
